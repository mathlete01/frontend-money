        ...
        <Accordion>
          ...
          <Card>
            ...
            <Accordion.Collapse eventKey="2">
              <Card.Body>There is a longstanding debate of which approach is superior between the Traditional and Roth IRAs. We prefer the Roth for two main reasons: Because Roth contributions are made after taxes, your money grows tax-free and remains tax-free when you withdraw it, while your withdrawals from a Traditional IRA are taxed as income. The second, and possibly more important benefit is that you are allowed to withdraw your contributions (not your earnings on those contributions, just your contributions) any time for any reason with no penalty, quite unlike the Traditional IRA. This means that your Roth IRA can double as an Emergency Fund. It's extremely difficult for most people to amass an Emergency Fund and keep it in a savings account earning pennies. If you regularly contribute to your Roth IRA, you can amass a sizable amount that can be liquidated in an emergency without incurring a tax penalty.</Card.Body>
            </Accordion.Collapse>
          </Card>
          <Card>
            <Card.Header>
