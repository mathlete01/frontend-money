  ...
  makeDetermination = () => {
    ...
    switch (true) {
      ...
      case credit_card_debt > leftover_money && four01k === false:
        ...
        this.advice = ``;
        this.what = `The total credit card debt you've listed here is $${credit_card_debt}. Apply the $${leftover_money} of monthly leftover money and you can pay off your debt in about ${this.calcMonths()} months.`;
        ...
        this.how = `Use the Debt Snowball method: Apply all your leftover money to the smallest debt you have, and pay just the minimum payment on your other cards. Once your smallest debt is paid off, move on to the next smallest. This method works well because it gives you success earlier than prioritizing the card with the highest interest rate. That early success is a powerful motivator to get it all paid off.`;
        this.nextStep = "RothIntro";
        break;
      ...
      case credit_card_debt < leftover_money &&
        ...
        this.headline = `Increase your 401(k) contribution 📈 and pay off your credit cards 💳`;
        this.advice = ``;
        this.what = `The total credit card debt you've listed here is $${credit_card_debt}. The $${leftover_money} you have left over after bills and spending money is more than enough to pay it off in under a month, so, do it. While it's great that you are taking advantage of your 401(k), you should to increase your 401(k) contribution from ${four01k_contribution}% to ${four01k_match}%.`;
        this.why = `The employer match is free money, so take advantage of it!`;
      ...
      case credit_card_debt < leftover_money &&
        ...
        this.headline = `Pay off your credit card debt 💳🧾`;
        this.advice = ``;
        this.what = `The total credit card debt you've listed here is $${credit_card_debt}. The $${leftover_money} you have left over after bills and spending money is more than enough to pay it off in under a month, so, do it. By the way, you're correct to restrict your 401(k) contribution to the company match of ${four01k_match}%.`;
        this.why = `The employer match is free money, so take advantage of it!`;
        this.how = `Use the Debt Snowball method: Apply all your leftover money to the smallest debt you have, and pay just the minimum payment on your other cards. Once your smallest debt is paid off, move on to the next smallest. This method works well because it gives you success earlier than prioritizing the card with the highest interest rate. That early success is a powerful motivator to get it all paid off.`;
        this.nextStep = "RothIntro";
        break;
