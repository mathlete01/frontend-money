  ...
  makeDetermination = () => {
    ...
    switch (true) {
      ...
      case four01k === false && credit_card_debt <= leftover_money:
        ...
        this.headline = `You can pay off your debt, no problem!`;
        this.advice = `Ok, so you've got a bit of credit card debt, but you have enough money left over after bills and spending money to pay if off in a month. So, PAY THE DAMN DEBT OFF THIS MONTH, YO. Let's make sure you qualify for a Roth IRA!`;
      ...
      case four01k_contribution > four01k_match &&
        ...
        this.headline = `You can pay off your debt, no problem!`;
        this.advice = `Ok, so you've got a bit of credit card debt, but you have enough money left over after bills and spending money to pay if off in a month. So, PAY THE DAMN DEBT OFF THIS MONTH, YO. Next, let's see if you qualify for a Roth IRA...`;
        this.nextStep = "RothIntro";
        break;
      ...
      case four01k_contribution < four01k_match && credit_card_debt < 1:
        ...
        this.advice = `You should to increase your 401k contribution from ${four01k_contribution}% to ${four01k_match}%. The employer match is free money, so take advantage of it! Next, let's see if you qualify for a Roth IRA...`;
        this.nextStep = "RothIntro";
        break;
      // Case:  Contribution < Match / Big Debt
      case four01k_contribution < four01k_match &&
        ...
        this.advice = `Right now, your top priority is to pay off your credit card debt. But before you do anything, you should to increase your 401k contribution from ${four01k_contribution}% to ${four01k_match}%. The employer match is free money, so take advantage of it! Make that change now, then focus on paying off your cards, starting with smallest debt you owe then the next smallest, and so on. Next, let's see if you qualify for a Roth IRA...`;
        this.nextStep = "RothIntro";
        break;
      // Case:  Contribution < Match / Small Debt
      case four01k_contribution < four01k_match &&
        ...
        console.log("*** Contribution < Match / Small Debt");
        this.headline = `Increase your 401(k) contribution and pay off your credit cards`;
        this.advice = `Ok, so you've got a bit of credit card debt, but you have enough money left over after bills and spending money to pay if off in a month. So, PAY THE DAMN DEBT OFF THIS MONTH, YO. But before you do anything, you should to increase your 401k contribution from ${four01k_contribution}% to ${four01k_match}%. The employer match is free money, so take advantage of it! Make that change now. Next, let's see if you qualify for a Roth IRA...`;
        this.nextStep = "RothIntro";
        break;
      // Case:  Contribution = Match / No Debt
      case four01k_contribution === four01k_match && credit_card_debt < 1:
        ...
        this.advice = `Well done--you're correct to restrict your 401k contribution to the company match of ${four01k_match}%. And no credit card debt--fantastic! Next, let's see if you qualify for a Roth IRA...`;
        this.nextStep = "RothIntro";
        break;
      // Case:  Contribution = Match / Big Debt
      case four01k_contribution === four01k_match &&
        ...
        console.log("*** Contribution = Match / Big Debt");
        this.headline = `Pay off your credit cards`;
        this.advice = `Well done--you're correct to restrict your 401k contribution to the company match of ${four01k_match}%. For now, focus on paying off your debt, starting with smallest cc then working your way up. Next, let's see if you qualify for a Roth IRA...`;
        this.nextStep = "RothIntro";
        break;
      // Case:  Contribution = Match / Small Debt
      case four01k_contribution === four01k_match &&
        ...
        console.log("*** Contribution = Match / Small Debt");
        this.headline = `You can pay off your debt, no problem!`;
        this.advice = `Ok, so you've got a bit of credit card debt, but you have enough money left over after bills and spending money to pay if off in a month. So, PAY THE DAMN DEBT OFF THIS MONTH, YO. Oh, and regarding your 401(k), you're correct to restrict your 401k contribution to the company match of ${four01k_match}%. Next, let's see if you qualify for a Roth IRA...`;
        this.nextStep = "RothIntro";
        break;
      default:
