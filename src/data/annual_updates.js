// updated for
const figures = {
	// The maximum you can contribute in 2021 is $22,500
	four01k_max_under_50: 22500,

	// 	MARRIED, FILING JOINTLY
	// As a couple, will your pre-tax income be less than $198,000 in 2021? 
	...
	// As a couple, will your pre-tax income be less than $228,000 in 2021? 
	// $228,000 is the maximum you can earn and still contribute to a Roth IRA.
	roth_married_jointly_max: 228000,
	
	// MARRIED, FILING SEPARATELY
	// Will you earn less than $10,000 in 2021?
	roth_married_not_jointly_min: 10000,

	// SINGLE TAXPAYERS AND HEADS OF HOUSEHOLD
	roth_single_min: 138000,
	// Will you earn less than $153,000 in 2021? That's the minimim amount you can earn to qualify for a Roth IRA if you are married but file your taxes as a single person
	roth_single_max: 153000,

	// Every year, the maximum you can contribute to a Roth IRA if you're 50 or over is $7,000.
